  ...
  return (
    <section id="features" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4">Dlaczego warto wybrać FitWise?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-[#F7F8FA] rounded-lg p-6 shadow-sm">
            <h3 className="font-semibold text-xl mb-2">Funkcja 1</h3>
          ...
          {/* Feature 2 */}
          <div className="bg-[#F7F8FA] rounded-lg p-6 shadow-sm">
            <h3 className="font-semibold text-xl mb-2">Funkcja 2</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 3 */}
          <div className="bg-[#F7F8FA] rounded-lg p-6 shadow-sm">
            <h3 className="font-semibold text-xl mb-2">Funkcja 3</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 4 */}
          <div className="bg-[#F7F8FA] rounded-lg p-6 shadow-sm">
            <h3 className="font-semibold text-xl mb-2">Funkcja 4</h3>
            <p className="text-gray-600">
